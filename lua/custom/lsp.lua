...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(event)
    ...
    vim.keymap.set('n', 'gd', '<cmd>Lspsaga peek_definition<CR>', 
        { buffer = bufnr, silent = true, noremap = true, desc = 'LSP: Peek Definition' })
    ...
    vim.keymap.set('n', 'gr', '<cmd>Lspsaga lsp_finder<CR>', 
        { buffer = bufnr, silent = true, noremap = true, desc = 'LSP: Find References' })
    ...
    vim.keymap.set('n', '<leader>rn', '<cmd>Lspsaga rename<CR>', 
        { buffer = bufnr, silent = true, noremap = true, desc = 'LSP: Rename' })
    ...
    vim.keymap.set('n', 'K', '<cmd>Lspsaga hover_doc<CR>', 
        { buffer = bufnr, silent = true, noremap = true, desc = 'LSP: Show Documentation' })
